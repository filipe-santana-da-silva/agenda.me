...
export default function ChatServicesModal({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/40 z-50 p-4 animate-in fade-in">
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-6xl max-h-[95vh] animate-in zoom-in-95 overflow-hidden flex">
        ...
        {/* Conteúdo Central - Serviços */}
        <div className="flex-1 p-6 lg:p-8 overflow-y-auto flex flex-col">
          <div className="flex items-center justify-between mb-6 lg:mb-8">
            <h2 className="text-xl lg:text-2xl font-bold text-gray-900">Selecione um serviço</h2>
            <Button
              onClick={() => {
                onOpenChange(false);
                onBack();
        ...
        {/* Resumo - Direita */}
        <div className="w-80 bg-gray-50 border-l border-gray-200 p-8 hidden lg:flex flex-col justify-between shrink-0">
          <div>
